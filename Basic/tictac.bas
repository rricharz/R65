2 PRINT TAB(15);"TIC-TAC-TOE"
4 REM CREATIVE COMPUTING
6 REM MORRISTOWN, NEW JERSEY
6 PRINT:PRINT:PRINT
...
502 IF M=0 THEN PRINT"THANKS.":GOTO 2000
503 IF M>9 THEN 506
505 IF S(M)=0 THEN 510
506 PRINT"SQUARE OCCUPIED.":PRINT:GOTO 500
510 G=1:S(M)=1
520 GOSUB 1000
530 GOTO 100
1000 FOR I=1TO9:PRINT" ";:IF S(I)<>-1 THEN 1014
...
1115 NEXT I:FOR I=1TO3:IF S(I)<>S(I+3)THEN 1150
...
1350 PRINT"I WIN. THANK YOU.":GOTO 2000
