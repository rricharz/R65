10 PRINT TAB(15);"AMAZING PROGRAM"
20 REM "CREATIVE COMPUTING"
21 REM "MORRISTOWN, NEW JERSEY"
30 PRINT:PRINT
100 INPUT "WIDTH AND LENGTH";H,V
102 IF H<>1 AND V<>1 THEN 110
104 PRINT "MEANINGLESS DIMENSIONS."
105 PRINT "TRY AGAIN.":GOTO 100
110 DIM W(H,V),V(H,V)
120 PRINT
130 PRINT
140 PRINT
